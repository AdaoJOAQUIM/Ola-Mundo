...
Portfolio moderno e responsivo criado com HTML, CSS e JavaScript puro.
...
3. **Personalize o conteúdo**
   ...
   - Modifique `style.css` para ajustar cores e estilos
   - Atualize os links de redes sociais

## 🎨 Personalização

### Cores
As cores principais estão definidas em variáveis CSS no arquivo `style.css`:
