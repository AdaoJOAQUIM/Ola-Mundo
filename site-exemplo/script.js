...
console.log('%c🚀 Portfolio criado com Claude Code!', 'color: #6366f1; font-size: 20px; font-weight: bold;');
console.log('%c📧 Interessado em trabalhar comigo? Entre em contato!', 'color: #8b5cf6; font-size: 14px;');
